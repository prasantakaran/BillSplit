...
/// Dialog collecting a new friend's details.
///
/// Returns the created [Friend] via [show], or null when cancelled. Saving
/// to Firestore is the caller's job — the dialog is UI only.
class AddFriendDialog extends StatefulWidget {
  const AddFriendDialog({super.key});

  static Future<Friend?> show(BuildContext context) {
